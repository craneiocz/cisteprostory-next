...
const IntegritaHepaFiltru = () => (
  <div className="min-h-screen bg-background">
    ...
    <main>
      ...
      <section className="border-b border-border py-16" aria-labelledby="odborne-hepa">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <p className="text-xs font-semibold uppercase tracking-[0.26em] text-primary">Navazující informace</p>
          <h2 id="odborne-hepa" className="mt-4 text-3xl font-bold tracking-tight text-foreground">Když částice a filtr říkají něco jiného</h2>
          <p className="mt-5 max-w-3xl leading-relaxed text-muted-foreground">Rozdíl mezi testem integrity, měřením částic a rozhodnutím po servisním zásahu vysvětluje <Link href="/ciste-prostory/integrita-hepa-filtru-a-pocet-castic" className="font-semibold text-primary underline underline-offset-4">průvodce kontrolou HEPA filtru a částic</Link>.</p>
        </div>
      </section>
    </main>
    <ServiceCrossLink />
